          ...
          {avatars.map((person, index) => {
            ...
            return (
              ...
              >
                {ringed && (
                  <div
                    className="name absolute left-1/2 text-center uppercase font-sans font-bold pointer-events-none text-foreground"
                    aria-hidden="true"
                    style={{
                      width: size,
                      height: size,
                    ...
                    {person.name.split("").map((char, i) => (
                      <span
                        ...
                        style={{
                          ...
                          transition: `opacity ${transition}s ease-out ${i * 0.01}s,
                            transform ${transition}s ease-out ${i * 0.01}s,
                            filter ${transition}s ease-out ${i * 0.01}s`,
                ...
                <div className="avatar-holder absolute inset-0 grid content-end">
                  <motion.span
                    className={cn(
                      "avatar inline-block w-full aspect-square rounded-full relative overflow-hidden",
                      "pointer-events-auto border-[3px] border-background",
