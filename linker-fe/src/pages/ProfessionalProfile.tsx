              ...
              <div className="w-64 shrink-0 self-start sticky top-6 flex flex-col gap-4">
                <div className="bg-surface border border-border rounded-2xl p-6 flex flex-col items-center text-center">
                  <div className="relative mb-3">
                    <div className="size-20 rounded-full overflow-hidden bg-primary/10 flex items-center justify-center border-2 border-background">
                      {selectedAvatar ? (
                    ...
                    <button
                      ...
                      className="absolute bottom-0 right-0 size-7 bg-primary text-white rounded-full flex items-center justify-center border-2 border-surface hover:scale-105 transition-transform cursor-pointer"
                    >
                  ...
                  <span className="mt-3 inline-block px-2.5 py-0.5 rounded-full bg-primary/10 text-primary text-xs font-semibold">
